...
<a href="https://dash.elest.io/deploy?source=cicd&social=Github&url=https://github.com/elestio-examples/django"><img src="myapp\static\myapp\images\deploy-on-elestio.png" alt="Deploy on Elest.io" width="180px" /></a>

Example application and CI/CD pipeline showing how to deploy a Django application to elestio.

<img src="myapp\static\myapp\images\screenshot.jpg" alt="screenshot of the example app" width="100%" />
...
But for this Django application example, you can choose GitHub as your deployment method.

### Step 3: Authentication

If you forked the repo then you can click on the sign-in with GitHub button and authorize elestio to access the git repo then you can select the django repo otherwise you can directly insert a git repo URL to deploy the django application.
